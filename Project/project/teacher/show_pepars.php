                        ...
                        ?>
                            ...
                            <div class="main-form mt-3 border-bottom">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mb-2">
                                        <label for="a">Ans</label>
                                            <input type="text" name="ans[]" class="form-control" required placeholder="<?php echo $row['ans'];?>"disabled>
                                        </div>
                                    </div>
                                </div>
                                <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="edit_username" class="form-control" value="<?php echo $row['teacher_name']?>"
